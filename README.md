...
A React app that is part of [Udacity's React Nanodegree](https://www.udacity.com/certificate/ZN5DQYLY) program and lets you play the "Would You Rather?" game in a web browser. Uses Redux for state management and is enhanced with a leaderboard and the ability to add new questions & users. 
